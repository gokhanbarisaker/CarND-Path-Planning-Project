#ifndef PP_LCL_TRAJECTORY_GENERATOR_H
#define PP_LCL_TRAJECTORY_GENERATOR_H
...
class LCLTrajectoryGenerator
{
public:
    LCLTrajectoryGenerator();
    virtual ~LCLTrajectoryGenerator() {}
